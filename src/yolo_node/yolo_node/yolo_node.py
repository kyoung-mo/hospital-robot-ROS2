...
class PoseNode(Node):
    def __init__(self):
        ...
        self.get_logger().info("✅ YOLO Pose Node Started (101/102 Mode)")

    def d435_callback(self, msg):
        self.current_location = msg.data # "101" 또는 "102"
                ...
                for person in keypoints:
                    ...
                    if 0.1 < height_diff < 30.0:
                        ...
                        if current_time - self.last_publish_time > 3.0:
                            ...
                            self.get_logger().error(f"🚨 [REAL FALL] Room {self.current_location}!")

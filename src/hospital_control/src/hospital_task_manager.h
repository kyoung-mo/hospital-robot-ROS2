...
private:
    ...
    rclcpp::Subscription<std_msgs::msg::String>::SharedPtr normal_call_sub_room1_;        // /hospital/call/101
    rclcpp::Subscription<std_msgs::msg::String>::SharedPtr normal_call_sub_room2_;  // /hospital/call/102
    ...
    rclcpp::Publisher<std_msgs::msg::String>::SharedPtr emergency_event_room1_;   // /hospital/emergency_event/101
    rclcpp::Publisher<std_msgs::msg::String>::SharedPtr emergency_event_room2_;   // /hospital/emergency_event/102
